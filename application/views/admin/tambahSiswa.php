            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid"> 
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                            <form action="<?=base_url()?>admin/saveSiswa" method="post" accept-charset="utf-8" class="form-horizontal row-fluid" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kelas_id">
                                        <option value="2">KELAS X - A</option>
                                        <option value="3">KELAS X - B</option>
                                        <option value="4">KELAS X - C</option>
                                        <option value="5">KELAS X - D</option>
                                        <option value="7">KELAS XI - IPA 1</option>
                                        <option value="8">KELAS XI - IPA 2</option>
                                        <option value="9">KELAS XI - IPS 1</option>
                                        <option value="10">KELAS XI - IPS 2</option>
                                        <option value="12">KELAS XII - IPA 1</option>
                                        <option value="13">KELAS XII - IPA 2</option>
                                        <option value="14">KELAS XII - IPS 1</option>
                                        <option value="15">KELAS XII - IPS 2</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="http://localhost:8080/new_elearning/index.php/siswa/index/1" class="btn">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
