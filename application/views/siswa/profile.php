                ...
                <div class="filters">
                    ...
                    <form action="<?=base_url('siswa/updateprofile/').$this->session->userdata('id');?>" method="post">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" value="<?= $profile[0]->nis?>" name="NIS" placeholder="Nama" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="agama" value="<?= $profile[0]->agama?>" placeholder="agama" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="tahunmasuk" value="<?= $profile[0]->tahun_masuk?>" placeholder="alamat" class="form-control">
                            </div>
                        </div>
